  ...
  home-manager.users.catdealer = { pkgs, lib, ... }: with lib.hm.gvariant; {
    ...
    dconf.settings = {
      ...
      "org/gnome/shell/extensions/openbar" = {
        ...
        dark-bguri = "";
        dark-hcolor = [ "0.125" "0.125" "0.125" ];
        dark-palette1 = [ "17" "20" "20" ];
        dark-palette10 = [ "141" "123" "112" ];
        dark-palette11 = [ "124" "124" "132" ];
        dark-palette12 = [ "124" "132" "128" ];
        dark-palette2 = [ "58" "60" "58" ];
        dark-palette3 = [ "38" "39" "38" ];
        dark-palette4 = [ "81" "81" "76" ];
        dark-palette5 = [ "27" "36" "34" ];
        dark-palette6 = [ "43" "52" "50" ];
        dark-palette7 = [ "67" "76" "72" ];
        dark-palette8 = [ "43" "44" "52" ];
        dark-palette9 = [ "67" "67" "76" ];
        default-font = "Sans 12";
        font = "CommitMono 10";
        hcolor = [ "0.125" "0.125" "0.125" ];
        height = 37.0;
        import-export = false;
        light-bguri = "";
        light-palette1 = [ "17" "20" "20" ];
        light-palette10 = [ "141" "123" "112" ];
        light-palette11 = [ "124" "124" "132" ];
        light-palette12 = [ "124" "132" "128" ];
        light-palette2 = [ "58" "60" "58" ];
        light-palette3 = [ "38" "39" "38" ];
        light-palette4 = [ "81" "81" "76" ];
        light-palette5 = [ "27" "36" "34" ];
        light-palette6 = [ "43" "52" "50" ];
        light-palette7 = [ "67" "76" "72" ];
        light-palette8 = [ "43" "44" "52" ];
        light-palette9 = [ "67" "67" "76" ];
        margin = 0.0;
        margin-wmax = 0.0;
        menustyle = false;
        monitor-height = 1080;
        ...
        neon = false;
        palette1 = [ "17" "20" "20" ];
        palette10 = [ "141" "123" "112" ];
        palette11 = [ "124" "124" "132" ];
        palette12 = [ "124" "132" "128" ];
        palette2 = [ "58" "60" "58" ];
        palette3 = [ "38" "39" "38" ];
        palette4 = [ "81" "81" "76" ];
        palette5 = [ "27" "36" "34" ];
